...
@Component({
  ...
  templateUrl: './print-students-national-numbers.component.html',
  styleUrls: ['./print-students-national-numbers.component.scss']
})
export class PrintStudentsNationalNumbersComponent implements OnInit  {
...
load() {
  if (!Helper.validator(this.filter, ['level_id','division_id'])) {
    ...
    this.globalService.loadHtml("affair/report47", this.filter).subscribe((res) => {
