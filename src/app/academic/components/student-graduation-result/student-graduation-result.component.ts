...
@Component({
  ...
  styleUrls: ['./student-graduation-result.component.scss']
})
export class StudentGraduationResultComponent implements OnInit {
...
getTotalPage() {
 ...
 change(){
  ...
  exportExcel() {
    const filename = "تقرير خريجين-"+new Date().toLocaleTimeString();
