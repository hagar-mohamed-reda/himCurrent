...
@Component({
  selector: 'app-student-affair-report11',
  templateUrl: './student-affair-report11.component.html',
  styleUrls: ['./student-affair-report11.component.scss']
})
export class StudentAffairReport11Component implements OnInit {
