...
@Component({
  selector: 'app-report21',
  templateUrl: './report21.component.html',
  styleUrls: ['./report21.component.scss']
})
export class Report21Component implements OnInit {
  ...
  load() {
    ...
    this.globalService.loadHtml("affair/report21", this.filter).subscribe((res) => {
